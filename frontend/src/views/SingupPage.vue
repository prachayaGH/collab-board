...
const handleSubmit = async () => {
  ...
  try {
    ...
    data: {
      ...
      display_name: `${signUpData.firstName} ${signUpData.lastName}`, // ✅ Map รวมชื่อ
      oauth_provider: 'local', // หรือใส่ 'google' ถ้ามาจากปุ่ม Google
      oauth_id: null,
      avatar_url: null
    },
  })
      ...
      <div class="bg-white py-8 px-6 shadow-lg rounded-lg border border-gray-200 animate-slide-up">
        <form class="space-y-6" @submit.prevent="handleSubmit">
          ...
          <div>
            ...
            <div class="relative">
              <input
                ...
                :class="[
                  ...
                  !passwordsMatch && signUpData.confirmPassword ? 'border-red-300 focus:ring-red-500' : ''
                ]"
            ...
            <p v-if="!passwordsMatch && signUpData.confirmPassword" class="mt-1 text-sm text-red-600">
